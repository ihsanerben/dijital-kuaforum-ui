// src/pages/AdminCalendarPage.jsx - TEMİZLENMİŞ HAL
...
const AdminCalendarPage = () => {
    ...
    // Bu kontrolü App.jsx'teki ProtectedRoute üstleniyor. Buradan kaldırılabilir.
    /* if (!isAdminLoggedIn()) {
    ...
    const columns = [
        ...
        { 
            ...
            key: 'customerName',
            render: (text, record) => record.customer ? record.customer.fullName : 'Tanımlanamadı',
        },
        { 
            title: 'Saat Aralığı', 
            key: 'timeRange', 
