...
const publicMenuItems = [
  {
    ...
    label: "Haftalık Randevu Takvimi",
  },
  { key: "/", label: "Anasayfa" },
...
const PublicLayout = ({ children }) => {
  ...
  const selectedKey =
    publicMenuItems.find((item) => location.pathname === item.key)?.key || "/";
  ...
  return (
    <>
      ...
      <Layout style={{ minHeight: "100vh" }}>
        ...
        {/* FOOTER KISMI */}
        <Footer
          style={{ backgroundColor: "#f0f2f5", padding: "40px 50px 10px" }}
        >
          <Row gutter={[32, 32]} justify="center">
            <Col xs={24} md={10}>
              ...
              <Paragraph style={{ color: "#595959" }}>
                Kuaför salonlarına özel dijital yazılım çözümleri sunuyoruz.
                Müşteri memnuniyetini en üst seviyeye taşımak için buradayız.
              </Paragraph>
              <div style={{ marginTop: 15 }}>
                <FacebookFilled
                  style={{ fontSize: "24px", marginRight: 10, color: "#444" }}
                />
                <InstagramFilled
                  style={{ fontSize: "24px", marginRight: 10, color: "#444" }}
                />
            ...
            <Col xs={24} md={10} style={{ marginLeft: "auto" }}>
              <Title level={5} style={{ color: "#000", marginBottom: 15 }}>
                <ArrowRightOutlined
                  style={{ marginRight: 8, color: "#695acb" }}
                />{" "}
                Bizimle İletişime Geçin
              </Title>
              <Paragraph style={{ color: "#595959", marginBottom: 10 }}>
                <HomeOutlined style={{ marginRight: 8, color: "#695acb" }} />{" "}
                Altınşehir Mahallesi Kral Sokak No: 1453 Daire: 7
              </Paragraph>
              <Paragraph style={{ color: "#595959", marginBottom: 10 }}>
                <MailOutlined style={{ marginRight: 8, color: "#695acb" }} />{" "}
                ihsanerben@gmail.com
              </Paragraph>
              <Paragraph style={{ color: "#595959" }}>
                <PhoneOutlined style={{ marginRight: 8, color: "#695acb" }} />{" "}
                0571 638 1453
              </Paragraph>
            </Col>
          </Row>
          ...
          >
            ...
            <Col>
              <Link href="#" style={{ color: "#8c8c8c", marginRight: 15 }}>
                Kullanım Şartları
              </Link>
              <Link href="#" style={{ color: "#8c8c8c", marginRight: 15 }}>
                Gizlilik Politikası
              </Link>
              <Link href="/contact" style={{ color: "#8c8c8c" }}>
                İletişim
              </Link>
            </Col>
          </Row>
